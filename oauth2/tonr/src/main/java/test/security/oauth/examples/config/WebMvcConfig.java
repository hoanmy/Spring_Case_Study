package test.security.oauth.examples.config;
...
import test.security.oauth.examples.tonr.SparklrService;
import test.security.oauth.examples.tonr.converter.AccessTokenRequestConverter;
import test.security.oauth.examples.tonr.impl.SparklrServiceImpl;
import test.security.oauth.examples.tonr.mvc.FacebookController;
import test.security.oauth.examples.tonr.mvc.SparklrController;
import test.security.oauth.examples.tonr.mvc.SparklrRedirectController;
