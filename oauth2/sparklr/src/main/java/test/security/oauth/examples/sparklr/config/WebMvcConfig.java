package test.security.oauth.examples.sparklr.config;
...
import test.security.oauth.examples.sparklr.PhotoInfo;
import test.security.oauth.examples.sparklr.PhotoService;
import test.security.oauth.examples.sparklr.impl.PhotoServiceImpl;
import test.security.oauth.examples.sparklr.mvc.AccessConfirmationController;
import test.security.oauth.examples.sparklr.mvc.AdminController;
import test.security.oauth.examples.sparklr.mvc.PhotoController;
import test.security.oauth.examples.sparklr.mvc.PhotoServiceUserController;
import test.security.oauth.examples.sparklr.oauth.SparklrUserApprovalHandler;
